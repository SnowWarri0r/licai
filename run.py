...
from api.ws import (router as ws_router, price_monitor_loop, backup_loop, briefing_loop,
                    dca_loop, eod_summary_loop, rule_mine_loop)
...
async def lifespan(app: FastAPI):
    ...
    task11 = asyncio.create_task(rule_mine_loop())
