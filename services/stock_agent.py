...
_TOOLS = [
    ...
    {"name": "get_market_sentiment", "description": "查大盘打板情绪(涨停数/连板高度/炸板率/赚钱效应/热点板块)和全市场涨跌家数(几家上涨几家下跌, 含沪/深/北分市场, 回答'今天普跌吗/多少家在跌/赚钱效应'), 判断是个股原因还是大盘普涨普跌; 也用于判断市场风格(打板赚钱效应高=追涨/动量有效; 炸板率高+亏钱效应=高位分歧/反转)。",
     "input_schema": {"type": "object", "properties": {}}},
