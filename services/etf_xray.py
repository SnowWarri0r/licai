...
THEME_SYN: dict[str, list[str]] = {
    ...
    # 云计算是一条从 IaaS 到 SaaS 的链: 服务器/存储(计算机设备)、IDC 机房(通信服务)、
    # 云网络(通信设备)、系统集成(IT服务)、云软件(软件开发) 都在里面。缺这条时
    # 表里查无此键 → 只剩「主题词与行业名互相包含」的兜底 → 云计算 ETF 全判偏题,
    # 实测 516510 被打成 0.0%「偏离显著」, 是表的问题不是基金挂羊头。
    "云计算": ["计算机设备", "通信服务", "通信设备", "IT服务", "软件开发"],
    "数据中心": ["通信服务", "计算机设备", "IT服务"],
    "算力": ["计算机设备", "半导体", "通信设备", "通信服务"],
    "大数据": ["软件开发", "IT服务", "计算机设备"],
    "数字经济": ["软件开发", "IT服务", "计算机设备", "通信服务", "数字媒体"],
    "机器人": ["自动化设备", "通用设备", "机器人"],
